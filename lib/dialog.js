      ...
      _vm._b(
        {
          ...
          on: { "update:visible": _vm.handleVisibleSync }
        },
        "DialogComponent",
        _vm.omit(_vm.$attrs, "visible"),
        false
      ),
      _vm.omit(_vm.$listeners, "update:visible")
    ),
    [
      _c("template", { slot: "title" }, [_vm._t("title")], 2),
      [_vm._t("default", null, { params: _vm.params, dialog: this })],
        ...
        [
          _c(
            ...
            [
              ...
              (!_vm.destroyOnClose
              ? _vm.rendered
              : _vm.bodyRenderAbleWithTransition)
                ? _c(
                    "div",
...
/* harmony default export */ var dialogvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    handleVisibleSync: function handleVisibleSync(val) {
      this.dialogVisible = val;
      this.$emit('update:visible', val);
    }
  },
  components: {
    DialogComponent: src_component
  }
});
