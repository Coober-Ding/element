      ...
      _c(
        "label-wrap",
        {
          attrs: {
            ...
            "update-all": _vm.elForm.labelWidth === "auto"
          }
        },
        [
          _vm.label || _vm.$slots.label
            ? _c(
                ...
                [
                  _vm._t("label", [
                    _vm._v(_vm._s(_vm.label + _vm.elForm.labelSuffix))
                  ])
                ],
                2
              )
...
/* harmony default export */ var form_itemvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    labelStyle: function labelStyle() {
      ...
      var labelWidth = this.labelWidth || this.elForm.labelWidth;
      if (labelWidth) {
  ...
  methods: {
    ...
    getRules: function getRules() {
      var formRules = this.elForm.rules;
    ...
    getFilteredListener: function getFilteredListener(trigger) {
    ...
    callListener: function callListener(trigger) {
      var _this3 = this;

      var listeners = this.getFilteredListener(trigger);
      listeners.forEach(function (listener) {
        var handler = listener.handler;
        if (handler) {
          handler(_this3.fieldValue, _this3.getModel());
        }
      });
    },
